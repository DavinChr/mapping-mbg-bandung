    ...
    <section className="max-w-7xl mx-auto min-h-[70vh] flex flex-col md:flex-row items-center justify-between gap-12 py-12" id="home">
      ...
      <div className="md:w-1/2 relative group">
        ...
        <div className="relative rounded-2xl overflow-hidden frame-border p-4">
          <img alt="Representasi Keadilan dan Ketahanan" className="w-full h-auto grayscale hover:grayscale-0 transition-all duration-1000 opacity-60 hover:opacity-100" src="public/images/MBG.jpg" />
        </div>
      </div>
    </section>
  );
